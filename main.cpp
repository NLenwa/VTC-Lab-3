	...
	int       nCmdShow)
{
	...
	main_window = CreateWindow(class_name, "WZR 2022/23, temat 6, wersja c [Y-autopilot, F10-test autop.]", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
